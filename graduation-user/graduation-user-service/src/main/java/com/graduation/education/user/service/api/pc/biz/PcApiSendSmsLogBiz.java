...
import com.graduation.education.user.common.req.SendSmsLogPageREQ;
import com.graduation.education.user.common.req.SendSmsLogSendREQ;
import com.graduation.education.user.common.resq.SendSmsLogPageRESQ;
import com.graduation.education.user.service.dao.PlatformDao;
import com.graduation.education.user.service.dao.SendSmsLogDao;
...
public class PcApiSendSmsLogBiz extends BaseBiz {
	...
	public Result<Page<SendSmsLogPageRESQ>> listForPage(SendSmsLogPageREQ req) {
		...
		SendSmsLogExample.Criteria c = example.createCriteria();
