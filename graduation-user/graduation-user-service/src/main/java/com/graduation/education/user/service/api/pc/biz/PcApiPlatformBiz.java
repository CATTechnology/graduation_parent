...
import com.graduation.education.user.common.req.PlatformDeleteREQ;
import com.graduation.education.user.common.req.PlatformPageREQ;
import com.graduation.education.user.common.req.PlatformSaveREQ;
import com.graduation.education.user.common.req.PlatformUpdateREQ;
import com.graduation.education.user.common.req.PlatformViewREQ;
import com.graduation.education.user.common.resq.PlatformPageRESQ;
import com.graduation.education.user.common.resq.PlatformViewRESQ;
import com.graduation.education.user.service.dao.PlatformDao;
import com.graduation.education.user.service.dao.impl.mapper.entity.Platform;
import com.graduation.education.user.service.dao.impl.mapper.entity.PlatformExample;
...
public class PcApiPlatformBiz {
	...
	public Result<Page<PlatformPageRESQ>> listForPage(PlatformPageREQ req) {
		...
		PlatformExample.Criteria c = example.createCriteria();
