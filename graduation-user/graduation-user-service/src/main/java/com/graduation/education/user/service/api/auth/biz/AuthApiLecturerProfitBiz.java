...
import com.graduation.education.user.common.bo.auth.AuthLecturerProfitPageBO;
import com.graduation.education.user.common.bo.auth.AuthLecturerProfitSaveBO;
import com.graduation.education.user.common.dto.auth.AuthLecturerProfitPageDTO;
...
import com.graduation.education.user.service.dao.LecturerProfitDao;
...
public class AuthApiLecturerProfitBiz extends BaseBiz {
	...
	public Result<Page<AuthLecturerProfitPageDTO>> list(AuthLecturerProfitPageBO authLecturerProfitPageBO) {
		...
		LecturerProfitExample.Criteria c = example.createCriteria();
