...
import com.graduation.education.user.service.dao.impl.mapper.SysMapper;
import com.graduation.education.user.service.dao.impl.mapper.entity.Sys;
import com.graduation.education.user.service.dao.impl.mapper.entity.SysExample;
...
public class SysDaoImpl implements SysDao {
	...
	public SysVO getSys() {
		...
		return  BeanUtil.copyProperties(list.get(0), SysVO.class);
	}
}