...
public enum ResultEnum {
    ...
    // token异常
    TOKEN_PAST(301, "token过期"),TOKEN_MISSING(30101, "token丢失"), TOKEN_ERROR(302, "token异常"),
    // 登录异常
    ...
    // 用户异常，5开头
    LECTURER_REQUISITION_REGISTERED(501, "申请失败！该手机没注册，请先注册账号"), STUDENT_REQUISITION_SIGN(501, "签到失败！请注册后再签到"), LECTURER_REQUISITION_WAIT(502, "申请失败！该账号已提交申请入驻成为讲师，待审核中，在7个工作日内会有相关人员与您联系确认"), LECTURER_REQUISITION_YET(503, "申请失败！该账号已成为讲师，请直接登录"),
    //
