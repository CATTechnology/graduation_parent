 ...
 */
package com.graduation.education.util.base;
...
import com.graduation.education.util.enums.AdvTargetEnum;
import com.graduation.education.util.enums.AuditStatusEnum;
import com.graduation.education.util.enums.CategoryTypeEnum;
import com.graduation.education.util.enums.ChannelTypeEnum;
import com.graduation.education.util.enums.CourseCategoryEnum;
import com.graduation.education.util.enums.CourseTypeEnum;
import com.graduation.education.util.enums.ExtractStatusEnum;
import com.graduation.education.util.enums.FileTypeEnum;
import com.graduation.education.util.enums.IsDefaultEnum;
import com.graduation.education.util.enums.IsEnableStatisticsEnum;
import com.graduation.education.util.enums.IsFreeEnum;
import com.graduation.education.util.enums.IsPayEnum;
import com.graduation.education.util.enums.IsPutawayEnum;
import com.graduation.education.util.enums.IsSendEnum;
import com.graduation.education.util.enums.IsShowServiceEnum;
import com.graduation.education.util.enums.IsSuccessEnum;
import com.graduation.education.util.enums.IsTimeSendEnum;
import com.graduation.education.util.enums.MsgTypeEnum;
import com.graduation.education.util.enums.NavEnum;
import com.graduation.education.util.enums.OrderStatusEnum;
import com.graduation.education.util.enums.PayTypeEnum;
import com.graduation.education.util.enums.PlatformEnum;
import com.graduation.education.util.enums.ProfitStatusEnum;
import com.graduation.education.util.enums.SexEnum;
import com.graduation.education.util.enums.StatusIdEnum;
import com.graduation.education.util.enums.SysTypeEnum;
import com.graduation.education.util.enums.TradeStatusEnum;
import com.graduation.education.util.enums.TradeTypeEnum;
import com.graduation.education.util.enums.UserTypeEnum;
import com.graduation.education.util.enums.VideoStatusEnum;
import com.graduation.education.util.enums.VideoTypeEnum;
import com.graduation.education.util.enums.ZoneLocationEnum;
...
public class BaseController extends Base {
	...
	public String getIpAddr(){
		return IPUtil.getIpAddress(httpServletRequest);
	}
